      ...
      <div className="my-10 px-5 flex justify-around gap-2 items-center flex-wrap">
        {links.map((link, index) => (
          <Link
            key={index}
            to={link.to}
            className="flex-grow w-[97%] sm:w-[400px] h-[180px] rounded-3xl border border-gray-300 flex flex-col items-center justify-center text-center bg-white hover:bg-blue-100 hover:border-blue-500 hover:ring-2 hover:ring-blue-500 transition duration-300 ease-in-out"
          >
